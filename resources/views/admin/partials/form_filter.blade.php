    ...
    <form action="{{route('admin')}}" id="filter_form" method="GET">
        <div class="filter-groups">
            ...
            <div style="display: {{isset($_GET['country_visible']) ? ($_GET['country_visible'] == '1' ? 'block' : 'none') : 'none'}}"
                ...
                <input type="checkbox" name="country[]" class="filter_checked sub-point"
                    value="{{$country->id}}" {{in_array($country->id, isset($_GET['country']) ? $_GET['country'] : []) ? 'checked' : ''}}>
            ...
            <div style="display: {{isset($_GET['sweet_visible']) ? ($_GET['sweet_visible'] == '1' ? 'block' : 'none') : 'none'}}"
                ...
                <input type="checkbox" name="sweet[]" class="filter_checked sub-point"
                    value="{{$sweet->id}}" {{in_array($sweet->id,isset($_GET['sweet'])?$_GET['sweet'] : []) ? 'checked' : ''}}>

...
<head>
    ...
    <link rel="stylesheet" href="{{ elixir('frontend/frontend.css') }}"> @yield('styles')
</head>
...
<body>
    ...
    <script type="text/javascript" src="{{URL::asset('frontend/js/modalWine.js')}}"></script> --}} @yield('scripts')
</body>
